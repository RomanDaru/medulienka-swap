  ...
  return (
    <SectionContainer
      ...
      <div className='max-w-2xl mx-auto text-center'>
        ...
        <div className='mb-10'>
          <h3 className='text-xl font-semibold text-honey-dark mb-4'>
            Sledujte nás na:
          </h3>
          <div className='flex justify-center space-x-6'>
            <a
              href='https://www.facebook.com/mcmedulienka' // Placeholder URL
              target='_blank'
            ...
            <a
              href='https://instagram.com/medulienka.levice' // Placeholder URL
              target='_blank'
              rel='noopener noreferrer'
              className='text-gray-700 hover:text-honey-dark transition-colors'
