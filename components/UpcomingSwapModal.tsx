...
const UpcomingSwapModal: React.FC<UpcomingSwapModalProps> = ({ isOpen, onClose, posterImageUrl }) => {
  React.useEffect(() => {
    if (isOpen) {
      ...
      >
        ...
        {posterImageUrl ? (
          ...
          <div className="text-center">
            ...
            <h2 id="modal-title" className="text-2xl md:text-3xl font-bold text-honey-dark mb-3">
              Najbližší Medulienka Swap!
            </h2>
            <p className="text-gray-600 text-lg mb-2">
              <strong>Kedy:</strong> Sobota, 25. Mája 2024, 14:00 - 17:00 <span className="text-sm text-gray-500">(Placeholder)</span>
            </p>
            <p className="text-gray-600 text-lg mb-4">
              <strong>Kde:</strong> Komunitné centrum Srdiečko, Hlavná 123 <span className="text-sm text-gray-500">(Placeholder)</span>
            </p>
            <p className="text-gray-700 mb-6">
              Prineste vecičky, ktoré už nepotrebujete, a nájdite nové poklady pre vaše deti. Tešíme sa na vás!
            </p>
            <button
              onClick={onClose}
