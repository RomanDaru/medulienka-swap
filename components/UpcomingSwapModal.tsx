...
const UpcomingSwapModal: React.FC<UpcomingSwapModalProps> = ({
  ...
  return (
    <div
      ...
      <div
        className='bg-white rounded-xl shadow-2xl p-6 md:p-8 w-full mx-auto md:max-w-3xl transform transition-all duration-300 ease-in-out scale-100 opacity-100 flex flex-col'
